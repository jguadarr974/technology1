      ...
      >
        ...
        <Title>
          <div className="content-wrapper" style={{ height: "90vh" }}>
            <div className="text-wrapper">
              <p
                className="mobile-text reveal active"
                style={{
                  padding: "3rem",
                  margin: "8rem",
                  fontStyle: "italic",
              ...
              >
                Our Mobile Team has contributed in providing with a camera
                feature, gallery, & location as well as using blockchain.
                <br />
                This can be uploaded and reviewed by the CMS team which will
                then be posted to the official website. <br />
              </p>
            </div>
            <StaticImage
              style={{ position: "absolute" }}
        ...
        <Section style={{ background: "#ab7f75" }}>
          <div className="container">
            <div className="cards" style={{ display: "flex" }}>
              <div
                className="text-card"
                style={{ background: "#60544b", borderRadius: "1rem" }}
              >
                <h3>Camera</h3>
                <p>
                  <br />
              ...
              >
                ...
                <p>
                  <br />
                  Users will get access to their gallery to upload any content
          ...
          <div className="content-wrapper" style={{ height: "90vh" }}>
            ...
            <div className="text-wrapper" style={{ letterSpacing: "7px" }}>
              <div className="blur-wrapper">
                <h1 className="textBlur" style={{ MozTransition: "4s" }}>
                  Content
                </h1>
                <h1 className="textBlur" style={{ MozTransition: "5s" }}>
                  Management
                </h1>
                <h1 className="textBlur" style={{ MozTransition: "6s" }}>
                  System
                </h1>
              </div>
            </div>
            <StaticImage
              style={{ position: "absolute" }}
              src="../images/technology/blur-code.jpeg"
              className="backgroundImg"
            />
          </div>
        </Title>
          ...
          <div className="container">
            ...
            <div className="cards" style={{ display: "flex" }}>
              <div className="text-card" style={{ borderRadius: "1rem" }}>
                ...
                <p>
                  <br />
                  The CMS has produced a registration and login page using
                  strapi.
                </p>
              </div>
              <div className="text-card" style={{ borderRadius: "1rem" }}>
                ...
                <p>
                  <br />
                  The cms team is able to check for users authentication using
                  strapi. Users can sign up with their google account or other
                  emails to get access to stories and other content.
                </p>
              </div>
              <div className="text-card" style={{ borderRadius: "1rem" }}>
                ...
                <p>
                  <br />
                  Once you sign up, you're able to download any content. You
                  also have the option to download from any media format!
                </p>
              </div>
            </div>
          </div>
        ...
        <Title id="section-3">
          <div className="content-wrapper" style={{ height: "70vh" }}>
            <div className="text-wrapper text-reveal">
              <h1
                className="show-up"
                style={{ zIndex: "10", letterSpacing: "4px" }}
              >
                Blockchain
              </h1>
            </div>
...
const Title = styled.div`
  ...
  .show-up.active:last-of-type {
    animation: reveal-it 7s linear forwards;
  }
